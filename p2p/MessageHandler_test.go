...
func (_m *MockMessageHandler) checkAuth(msgHeader p2pcommon.Message, msgBody proto.Message) error {
	ret := _m.Called(msgHeader, msgBody)

	var r0 error
	if rf, ok := ret.Get(0).(func(p2pcommon.Message, proto.Message) error); ok {
...
func (_m *MockMessageHandler) postHandle(msgHeader p2pcommon.Message, msgBody proto.Message) {
}
func (_m *MockMessageHandler) preHandle() {
}

// handle provides a mock function with given fields: msgHeader, msgBody
func (_m *MockMessageHandler) handle(msgHeader p2pcommon.Message, msgBody proto.Message) {
