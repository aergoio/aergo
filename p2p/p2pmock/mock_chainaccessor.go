...
// HardforkHeights mocks base method
func (m *MockChainAccessor) HardforkHeights() map[string]uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HardforkHeights")
	ret0, _ := ret[0].(map[string]uint64)
	return ret0
}

// HardforkHeights indicates an expected call of HardforkHeights
func (mr *MockChainAccessorMockRecorder) HardforkHeights() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HardforkHeights", reflect.TypeOf((*MockChainAccessor)(nil).HardforkHeights))
}
