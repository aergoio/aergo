...
// Source: p2p/p2pcommon/handshake.go
...
func (m *MockHSHandlerFactory) CreateHSHandler(p2pVersion p2pcommon.P2PVersion, outbound bool, pid go_libp2p_peer.ID) p2pcommon.HSHandler {
...
func (m *MockVersionedManager) GetVersionedHandshaker(version p2pcommon.P2PVersion, peerID go_libp2p_peer.ID, r io.Reader, w io.Writer) (p2pcommon.VersionedHandshaker, error) {
