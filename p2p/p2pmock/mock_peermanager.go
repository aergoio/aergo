...
// Source: github.com/aergoio/aergo/p2p/p2pcommon (interfaces: PeerManager)
...
func (m *MockPeerManager) GetPeerAddresses(arg0, arg1 bool) []*message.PeerInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPeerAddresses", arg0, arg1)
...
func (m *MockPeerManager) NotifyPeerHandshake(arg0 go_libp2p_peer.ID) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "NotifyPeerHandshake", arg0)
}
