...
function bignum_fns()
    ...
    print("bignum.ispos")
    m1k(bignum.ispos, nines_b)
    m1k(bignum.ispos, nines1_b)
    m1k(bignum.ispos, nines2_b)
    m1k(bignum.ispos, one_b)
    m1k(bignum.ispos, b_b)
    m1k(bignum.ispos, pi_b)
    m1k(bignum.ispos, pi1_b)
    print("bignum.isneg")
