...
func TestTransformAmount(t *testing.T) {
	...
	tests := []struct {
		...
		// Invalid Order
		{"789aer 456gaer 123aergo", bigIntFromString("123000000456000000789"), nil},
		{"789 aer 456 gaer 123 aergo", bigIntFromString("123000000456000000789"), nil},
		{"789aer 123aergo 456gaer", bigIntFromString("123000000456000000789"), nil},
		{"789 aer 123 aergo 456 gaer", bigIntFromString("123000000456000000789"), nil},
		{"456gaer 789aer 123aergo", bigIntFromString("123000000456000000789"), nil},
		{"123aergo 789aer 456gaer", bigIntFromString("123000000456000000789"), nil},
		// Repeated Units
		{"123aergo 456aergo", bigIntFromString("579000000000000000000"), nil},
		{"123gaer 456gaer", bigIntFromString("579000000000"), nil},
		{"123aer 456aer", bigIntFromString("579"), nil},
		{"123 aergo 456 aergo", bigIntFromString("579000000000000000000"), nil},
		{"123 gaer 456 gaer", bigIntFromString("579000000000"), nil},
		{"123 aer 456 aer", bigIntFromString("579"), nil},
		{"123aergo 456aergo 789aer", bigIntFromString("579000000000000000789"), nil},
		{"123aergo 456aergo 789gaer", bigIntFromString("579000000789000000000"), nil},
		{"123aergo 456gaer 789gaer", bigIntFromString("123000001245000000000"), nil},
		{"123aergo 456aer 789aer", bigIntFromString("123000000000000001245"), nil},
		{"123 aergo 456 aergo 789 aer", bigIntFromString("579000000000000000789"), nil},
		{"123 aergo 456 aergo 789 gaer", bigIntFromString("579000000789000000000"), nil},
		{"123 aergo 456 gaer 789 gaer", bigIntFromString("123000001245000000000"), nil},
		{"123 aergo 456 aer 789 aer", bigIntFromString("123000000000000001245"), nil},
