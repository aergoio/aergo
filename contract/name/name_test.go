...
func TestName(t *testing.T) {
	...
	sender, _ := state.GetAccountState(tx.Account, sdb.GetStateDB(), sdb.GetEvmStateDB())
	receiver, _ := state.GetAccountState(tx.Recipient, sdb.GetStateDB(), sdb.GetEvmStateDB())
