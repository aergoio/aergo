...
ast_stmt_t *stmt_new_loop(loop_kind_t kind, ast_stmt_t *init_stmt, ast_exp_t *cond_exp,
                          ast_stmt_t *post_stmt, ast_blk_t *blk, src_pos_t *pos);
...
ast_stmt_t *stmt_new_pragma(pragma_kind_t kind, ast_exp_t *val_exp, char *val_str,
                            ast_exp_t *desc_exp, src_pos_t *pos);

ast_stmt_t *stmt_make_assign(ast_id_t *var_id, ast_exp_t *val_exp);
ast_stmt_t *stmt_make_malloc(uint32_t reg_idx, uint32_t size, src_pos_t *pos);
