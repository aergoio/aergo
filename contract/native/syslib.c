...
sys_fn_t sys_fntab_[FN_MAX] = {
    ...
    { "atoi64", SYSLIB_MODULE".atoi64", 1, { TYPE_STRING }, TYPE_UINT64 },
    { "itoa32", SYSLIB_MODULE".itoa32", 1, { TYPE_UINT32 }, TYPE_STRING },
    { "itoa64", SYSLIB_MODULE".itoa64", 1, { TYPE_UINT64 }, TYPE_STRING },
    ...
    { "mpz_get_str", SYSLIB_MODULE".mpz_get_str", 1, { TYPE_UINT32 }, TYPE_STRING },
    { "mpz_set_i32", SYSLIB_MODULE".mpz_set_i32", 2, { TYPE_UINT32, TYPE_UINT32 }, TYPE_UINT32 },
    { "mpz_set_i64", SYSLIB_MODULE".mpz_set_i64", 2, { TYPE_UINT64, TYPE_UINT32 }, TYPE_UINT32 },
    { "mpz_set_str", SYSLIB_MODULE".mpz_set_str", 1, { TYPE_STRING }, TYPE_UINT32 },
    ...
    { "mpz_rshift", SYSLIB_MODULE".mpz_rshift", 2, { TYPE_UINT32, TYPE_UINT32 }, TYPE_UINT32 },
    { "mpz_lshift", SYSLIB_MODULE".mpz_lshift", 2, { TYPE_UINT32, TYPE_UINT32 }, TYPE_UINT32 },
    { "mpz_cmp", SYSLIB_MODULE".mpz_cmp", 2, { TYPE_UINT32, TYPE_UINT32 }, TYPE_UINT32 },
