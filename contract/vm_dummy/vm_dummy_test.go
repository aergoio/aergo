...
func readLuaCode(file string) (luaCode string) {
	...
	raw, err := os.ReadFile(filepath.Join(path, "sample", file))
	if err != nil {
		return ""
	}
	return string(raw)
...
func TestContractSystem(t *testing.T) {
	code := readLuaCode("system.lua")
	require.NotNil(t, code, "failed to read system.lua")
...
func TestContractHello(t *testing.T) {
	code := readLuaCode("hello.lua")
	require.NotNil(t, code, "failed to read hello.lua")
...
func TestContractSend(t *testing.T) {
	code := readLuaCode("send_1.lua")
	require.NotNil(t, code, "failed to read send_1.lua")
	code2 := readLuaCode("send_2.lua")
	require.NotNil(t, code2, "failed to read send_2.lua")
	code3 := readLuaCode("send_3.lua")
	require.NotNil(t, code3, "failed to read send_3.lua")
	code4 := readLuaCode("send_4.lua")
	require.NotNil(t, code4, "failed to read send_4.lua")
...
func TestContractSendF(t *testing.T) {
	code := readLuaCode("sendf_1.lua")
	require.NotNil(t, code, "failed to read sendf_1.lua")
	code2 := readLuaCode("sendf_2.lua")
	require.NotNil(t, code2, "failed to read sendf_2.lua")
...
func TestContractQuery(t *testing.T) {
	code := readLuaCode("query.lua")
	require.NotNil(t, code, "failed to read query.lua")
...
func TestContractCall(t *testing.T) {
	code := readLuaCode("call_1.lua")
	require.NotNil(t, code, "failed to read call_1.lua")
	code2 := readLuaCode("call_2.lua")
	require.NotNil(t, code2, "failed to read call_2.lua")
...
func TestContractPingpongCall(t *testing.T) {
	code := readLuaCode("pingpongcall_1.lua")
	require.NotNil(t, code, "failed to read pingpongcall_1.lua")
	code2 := readLuaCode("pingpongcall_2.lua")
	require.NotNil(t, code2, "failed to read pingpongcall_2.lua")
...
func TestRollback(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read rollback.lua")
	bc, err := LoadDummyChain()
	require.NoErrorf(t, err, "failed to create dummy chain")
	defer bc.Release()
...
func TestAbi(t *testing.T) {
	...
	require.NotNil(t, codeNoAbi, "failed to read abi_no.lua")
	codeEmpty := readLuaCode("abi_empty.lua")
	require.NotNil(t, codeEmpty, "failed to read abi_empty.lua")
	codeLocalFunc := readLuaCode("abi_localfunc.lua")
	require.NotNil(t, codeLocalFunc, "failed to read abi_localfunc.lua")
...
func TestGetABI(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read getabi.lua")
...
func TestPayable(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read payable.lua")
...
func TestDefault(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read default.lua")
...
func TestReturn(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read return_1.lua")
	code2 := readLuaCode("return_2.lua")
	require.NotNil(t, code, "failed to read return_2.lua")
...
func TestReturnUData(t *testing.T) {
	code := readLuaCode("returnudata.lua")
	require.NotNil(t, code, "failed to read returnudata.lua")
...
func TestEvent(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read event.lua")
...
func TestView(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read view.lua")
...
func TestDeploy(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read deploy.lua")
...
func TestDeploy2(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read deploy2.lua")
...
func TestNDeploy(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read deployn.lua")
...
func TestDeployFee(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read deployfee.lua")
	...
	r := bc.GetReceipt(tx.Hash())
	assert.Equalf(t, uint64(117861), r.GetGasUsed(), "not same gas used")

	state, err = bc.GetAccountState("ktlee")
	require.NoErrorf(t, err, "failed to get account state")
	after := state.GetBalanceBigInt().Uint64()
	assert.Equalf(t, before-uint64(117861), after, "not same balance")
}

func xestInfiniteLoop(t *testing.T) {
	code := readLuaCode("infiniteloop.lua")
	require.NotNil(t, code, "failed to read infiniteloop.lua")
...
func TestUpdateSize(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read updatesize.lua")
...
func TestTimeoutCnt(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read timeout_1.lua")

	code2 := readLuaCode("timeout_2.lua")
	require.NotNil(t, code, "failed to read timeout_2.lua")
...
func TestSnapshot(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "snap", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestKvstore(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "map", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.register(init, get)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "auto", 0, definition),
...
abi.register(stmt_exec, stmt_exec_pcall, get)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "on_conflict", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.register(get)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "dup_col", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.register(createAndInsert, insertRollbackData, query, count, all)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "simple-query", 0, definition),
	)
	_ = bc.ConnectBlock(
...
abi.register(init, add, addFail, get)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "fail", 0, definition),
...
abi.register(init, nowNull, localtimeNull, get)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "datetime", 0, definition),
...
abi.register(createTable, query, insert, update, delete, count)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "customer", 0, definition),
		NewLuaTxCall(
			"ktlee",
			"customer",
			0,
...
abi.register(createDataTypeTable, dropDataTypeTable, insertDataTypeTable, queryOrderByDesc, queryGroupByBlockheight1)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "datatype", 0, definition),
		NewLuaTxCall(
			"ktlee",
			"datatype",
			0,
...
abi.register(sql_func, abs_func, typeof_func)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "fns", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.register(createTable, makeBook, copyBook, viewCopyBook, viewJoinBook)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "book", 0, definition),
		NewLuaTxCall(
			"ktlee",
			"book",
			0,
...
abi.register(r)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "r", 0, definition),
		tx,
	)
	if err == nil {
		t.Error(err)
...
abi.register(init, exec, query, getmeta, queryS)`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "jdbc", 0, definition),
...
func TestTypeOP(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read op.lua")
	...
	err = bc.ConnectBlock(
		...
		NewLuaTxDeploy("ktlee", "op", 0, string(code)),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestTypeBF(t *testing.T) {
	...
	require.NotNil(t, code, "failed to read bf.lua")
...
abi.register(oom, p, cp)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "oom", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestTypeNsec(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "nsec", 0, definition),
	)
	err = bc.ConnectBlock(
...
func TestTypeUtf(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "utf", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "dupVar", 0, dupVar),
	)
	if err == nil {
...
`
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "dupVar1", 0, dupVar),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "invalidkey", 0, src),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestTypeArray(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "array", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
	...
	`
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "overflow", 0, overflow),
	)
...
func TestTypeMultiArray(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "ma", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "ma", 0, definition2),
	)
...
func TestTypeArrayArg(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "a", 0, definition1),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	_ = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "a", 0, definition),
	)
	...
	_ = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "x", 0, definition),
	)
	err = bc.ConnectBlock(
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "datetime", 0, src),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "zeroLen", 0, zeroLen),
	)
	if err == nil {
...
`
	tx := NewLuaTxDeploy("ktlee", "dArr", 0, dArr)
	err = bc.ConnectBlock(tx)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "crypto", 0, src),
	)
...
abi.register(random)`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "random", 0, random),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "big", 0, bigSrc),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		...
		NewLuaTxDeploy("ktlee", "big20", 0, bigSrc),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestTypeJson(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "json", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.register(addCandidate, getCandidates, registerVoter, vote)`
	...
	_ = bc.ConnectBlock(
		...
		NewLuaTxDeploy("owner", "vote", 0, definition),
...
`
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "gov", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestFeaturePcallRollback(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "counter", 10, definition1).Constructor("[0]"),
	...
	`
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "caller", 10, definition2).
	...
	err = bc.ConnectBlock(
		...
		NewLuaTxDeploy("ktlee", "counter", 0, definition3),
	)
	if err != nil {
		t.Error(err)
	}
...
abi.payable(pcall1, default, constructor)
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxAccount("bong", 0),
		NewLuaTxDeploy("ktlee", "pcall", 10000000000000000000, definition1),
	)
	if err != nil {
		t.Error(err)
	}
...
func TestFeatureLuaCryptoVerifyProof(t *testing.T) {
	...
	err = bc.ConnectBlock(
		NewLuaTxAccount("ktlee", 100000000000000000),
		NewLuaTxDeploy("ktlee", "eth", 0, definition),
	)
	if err != nil {
		t.Error(err)
	}
...
`
	...
	err = bc.ConnectBlock(
		...
		NewLuaTxDeploy("ktlee", "fd", 0, definition),
...
`
	err = bc.ConnectBlock(
		NewLuaTxDeploy("ktlee", "fd2", 0, definition2),
	)
