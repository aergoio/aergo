...
func (*Paginations) Descriptor() ([]byte, []int) {
	return fileDescriptor_polarrpc_66b45308873a301f, []int{0}
}
...
func (*PolarisPeerList) Descriptor() ([]byte, []int) {
	return fileDescriptor_polarrpc_66b45308873a301f, []int{1}
}
...
func (*PolarisPeer) Descriptor() ([]byte, []int) {
	return fileDescriptor_polarrpc_66b45308873a301f, []int{2}
}
...
func init() { proto.RegisterFile("polarrpc.proto", fileDescriptor_polarrpc_66b45308873a301f) }

var fileDescriptor_polarrpc_66b45308873a301f = []byte{
