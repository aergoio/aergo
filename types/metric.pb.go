...
func (MetricType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metric_6b06b58837f6e8cb, []int{0}
}
...
func (*Metrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_metric_6b06b58837f6e8cb, []int{1}
}
...
func (*PeerMetric) Descriptor() ([]byte, []int) {
	return fileDescriptor_metric_6b06b58837f6e8cb, []int{2}
}
...
func init() { proto.RegisterFile("metric.proto", fileDescriptor_metric_6b06b58837f6e8cb) }

var fileDescriptor_metric_6b06b58837f6e8cb = []byte{
