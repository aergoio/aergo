...
func (*PeerAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_1b8ec1be79604f8f, []int{0}
}
...
func init() { proto.RegisterFile("node.proto", fileDescriptor_node_1b8ec1be79604f8f) }

var fileDescriptor_node_1b8ec1be79604f8f = []byte{
