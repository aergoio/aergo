...
type Proposal struct {
	...
	Blockfrom            uint64   `protobuf:"varint,4,opt,name=blockfrom,proto3" json:"blockfrom,omitempty"`
	Blockto              uint64   `protobuf:"varint,5,opt,name=blockto,proto3" json:"blockto,omitempty"`
	Maxvote              uint32   `protobuf:"varint,6,opt,name=maxvote,proto3" json:"maxvote,omitempty"`
	Candidates           []string `protobuf:"bytes,7,rep,name=candidates,proto3" json:"candidates,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Proposal) GetBlockfrom() uint64 {
	if m != nil {
		return m.Blockfrom
	}
	return 0
...
func (m *Proposal) GetBlockto() uint64 {
	if m != nil {
		return m.Blockto
	}
	return 0
...
func (m *Proposal) GetMaxvote() uint32 {
	if m != nil {
		return m.Maxvote
	}
	return 0
...
func (m *Proposal) GetCandidates() []string {
	if m != nil {
		return m.Candidates
	}
	return nil
...
var fileDescriptor_e9ac6287ce250c9a = []byte{
	...
	,
}
