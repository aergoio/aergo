...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c73efce70f877dec, []int{0}
}
...
func (*AccountList) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_c73efce70f877dec, []int{1}
}
...
func init() { proto.RegisterFile("account.proto", fileDescriptor_account_c73efce70f877dec) }

var fileDescriptor_account_c73efce70f877dec = []byte{
