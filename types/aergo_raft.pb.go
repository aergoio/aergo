...
var file_aergo_raft_proto_rawDesc = []byte{
	...
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x41, 0x50, 0x50, 0x4c, 0x49, 0x45, 0x44, 0x10, 0x02, 0x42, 0x09,
...
var file_aergo_raft_proto_goTypes = []interface{}{
...
func file_aergo_raft_proto_init() {
	...
	file_p2p_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_aergo_raft_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_aergo_raft_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
