...
func (e *EVM) create(input []byte, cfg *Config) ([]byte, common.Address, uint64, error) {
...
// be set.
func (e *EVM) call(address common.Address, input []byte, cfg *Config) ([]byte, uint64, error) {
	if cfg == nil {
